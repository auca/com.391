...
namespace aur {
    ...
    public:
        ES2PhongMaterial() {
            _vertex_shader_source = FileUtilities::read_text_file("data/shaders/es2_phong_shader.vert");
            _fragment_shader_source = FileUtilities::read_text_file("data/shaders/es2_phong_shader.frag");
