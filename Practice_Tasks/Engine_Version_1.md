...
* <https://github.com/toksaitov/asr-project/tree/a2264c33603ac0c380dcf8e9d23095c7f0d95722>

Note that you must point Git to a specific commit to get Version 1.3 of the graphics engine.

```bash
git clone https://github.com/toksaitov/asr-project.git asr-1.3
cd asr-1.3
git checkout a2264c33603ac0c380dcf8e9d23095c7f0d95722
```
...
Upon completing the task, add the following comment anywhere in your `lighting_test.cpp` file: `// I confirm that I have successfully added a second point light and it works.` This is required to pass the CI test. Additionally, don't forget to check the screenshot generated by the CI test to ensure that the scene is rendered correctly on the instructor's side.
