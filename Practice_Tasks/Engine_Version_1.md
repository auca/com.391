...
* <https://github.com/toksaitov/asr-project/tree/d33cf7c0972a540741128f59c48adf229703c847>

Note that you need to point to a specific commit to get Version 1.1 of the graphics engine.

```bash
git clone https://github.com/toksaitov/asr-project.git
git checkout d33cf7c0972a540741128f59c48adf229703c847
```
...
Commit and push to the private repository (get it from the instructor if you don't have one). You should send the `triangle_test.cpp`, `sphere_test.cpp`, and `box_test.cpp` files under the `lab-2` directory. Do not submit any other files. Your grade will be lowered for that. Submit the last commit URL to Canvas before the deadline.
...
```bash
git clone https://github.com/toksaitov/asr-project.git
git checkout 79da14b052f4691c4ca01d9aa0df51ff8b43c7d0
```
